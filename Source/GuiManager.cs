...
namespace FreeIva
{
    class GuiManager
    {
        ...
        public static void Gui()
        {
            ...
            KerbalIva.KerbalColliderCollider.enabled = KerbalIva.KerbalFeetCollider.enabled = !GUILayout.Toggle(!KerbalIva.KerbalColliderCollider.enabled, "NoClip");
        ...
        private static void ColliderGui()
        {
            ...
            if (GUILayout.Button("Stop all movement"))
            {
                ...
                {
                    col.IvaGameObject.GetComponentCached<Rigidbody>(ref col.IvaGameObjectRigidbody);
            ...
            if (c != null)
            {
                ...
                GUILayout.BeginHorizontal();
                c.IvaGameObject.GetComponentCached<Rigidbody>(ref c.IvaGameObjectRigidbody);
        ...
        public static void PhysicsGui()
        {
            ...
            if (showPhysicsGui)
            {
                ...
                GuiUtils.label("G-Force X", KerbalIva.gForce.x);
                GuiUtils.label("G-Force Y", KerbalIva.gForce.y);
                GuiUtils.label("G-Force Z", KerbalIva.gForce.z);
